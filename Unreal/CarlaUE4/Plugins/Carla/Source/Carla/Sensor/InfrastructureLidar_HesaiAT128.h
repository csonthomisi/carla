...
#include "InfrastructureLidar_HesaiAT128.generated.h"

/// A ray-cast based Lidar sensor.
UCLASS()
class CARLA_API AInfrastructureLidar_HesaiAT128 : public ARayCastSemanticLidar
{
  GENERATED_BODY()
...
public:
  ...
  AInfrastructureLidar_HesaiAT128(const FObjectInitializer &ObjectInitializer);
...
protected:
  ...
  // virtual void SimulateLidar(const float DeltaTime) override;
