...
FActorDefinition AInfrastructureLidar_OusterOS2128::GetSensorDefinition()
{
  return UActorBlueprintFunctionLibrary::MakeLidarDefinition(TEXT("ouster_os2_128"));
}


AInfrastructureLidar_OusterOS2128::AInfrastructureLidar_OusterOS2128(const FObjectInitializer& ObjectInitializer)
...
void AInfrastructureLidar_OusterOS2128::LoadBeams()
{
    // Your custom logic
    FString Path = FPaths::ProjectContentDir() / TEXT("Carla/Blueprints/Sensors/OusterOS2128.json");
...
void AInfrastructureLidar_OusterOS2128::Set(const FActorDescription &ActorDescription)
{
...
void AInfrastructureLidar_OusterOS2128::Set(const FLidarDescription &LidarDescription)
{
...
void AInfrastructureLidar_OusterOS2128::PostPhysTick(UWorld *World, ELevelTick TickType, float DeltaTime)
{
  TRACE_CPUPROFILER_EVENT_SCOPE(AInfrastructureLidar_OusterOS2128::PostPhysTick);
...
float AInfrastructureLidar_OusterOS2128::ComputeIntensity(const FSemanticDetection& RawDetection) const
{
...
AInfrastructureLidar_OusterOS2128::FDetection AInfrastructureLidar_OusterOS2128::ComputeDetection(const FHitResult& HitInfo, const FTransform& SensorTransf) const
{
  ...
  void AInfrastructureLidar_OusterOS2128::PreprocessRays(uint32_t Channels, uint32_t MaxPointsPerChannel) {
  ...
  bool AInfrastructureLidar_OusterOS2128::PostprocessDetection(FDetection& Detection) const
  {
  ...
  void AInfrastructureLidar_OusterOS2128::CreateLasers()
  {
    if (!bUseMetadata)
    {
  ...
  void AInfrastructureLidar_OusterOS2128::ComputeAndSaveDetections(const FTransform& SensorTransform) {
