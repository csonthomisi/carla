...
#include "InfrastructureLidar.generated.h"

/// A ray-cast based Lidar sensor.
UCLASS()
class CARLA_API AInfrastructureLidar : public ARayCastSemanticLidar
{
  GENERATED_BODY()
...
public:
  ...
  AInfrastructureLidar(const FObjectInitializer &ObjectInitializer);
