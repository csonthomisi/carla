...
#include "InfrastructureLidar_OusterOS2128.generated.h"

/// A ray-cast based Lidar sensor.
UCLASS()
class CARLA_API AInfrastructureLidar_OusterOS2128 : public ARayCastSemanticLidar
{
  GENERATED_BODY()
...
public:
  ...
  AInfrastructureLidar_OusterOS2128(const FObjectInitializer &ObjectInitializer);
